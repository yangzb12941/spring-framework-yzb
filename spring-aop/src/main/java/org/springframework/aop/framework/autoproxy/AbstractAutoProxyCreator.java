...
public abstract class AbstractAutoProxyCreator extends ProxyProcessorSupport
	 ...
	 *
	 * 为给定的bean创建一个AOP代理。
	 * 对于代理类的创建及处理， Spring 委托给了 ProxyFactory去处理，而在此函数中主要是对
	...
	protected Object createProxy(Class<?> beanClass, @Nullable String beanName,
		...
		//封装 Advisor 并加入到 ProxyFactory 中以及创建代理是两个相对繁琐的过程，可以
		//通过 ProxyFactory 提供的 addAdvisor 方法直接将增强器置入代理创建工厂中，
		// 但是将拦截器 封装为增强器还是需要一定的逻辑的。
