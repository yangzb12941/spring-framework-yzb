...
public class AspectJAopTest {
    ...
    public void aspectJAopTest_2() throws IOException {
		...
		ProxyFactory proxyFactory = ac.getBean("proxyFactory", ProxyFactory.class);
		proxyFactory.setExposeProxy(Boolean.TRUE);
		AspectJAopTarget aspectJAopTargetB = (AspectJAopTarget)AopContext.currentProxy();
		aspectJAopTargetB.aopMethodBefore();
    }
}
